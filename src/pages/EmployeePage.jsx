...
export default function EmployeePage() {
  ...
  function printSlipKaryawan(slip) {
    ...
    const dibayarTgl = new Date(slip.dibayarkan_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })
...
<div class="bersih">
  <div><div class="bersih-l">Gaji Bersih Diterima</div><div class="bersih-v">Rp ${(s.gaji_bersih||0).toLocaleString('id-ID')}</div><div class="paid-badge">✅ Dibayarkan ${dibayarTgl}</div></div>
</div>
            ...
            <div style={{background:T.surface, borderRadius:'20px 20px 0 0', padding:'20px 18px 80px', width:'100%', maxHeight:'90vh', overflowY:'auto'}}>
              ...
              <div style={{background:T.green, borderRadius:14, padding:'16px 18px', marginBottom:14, display:'flex', justifyContent:'space-between', alignItems:'center'}}>
                <div>
                  ...
                  <div style={{fontSize:10, color:'rgba(255,255,255,.7)', marginTop:4}}>✅ Dibayarkan {dibayarTgl}</div>
                </div>
              </div>
